...
<head>
    ...
    <title>Tentang Developer - RPS AMIKOM</title>
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project AMIKOM </h1>
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang AMIKOM</h2>
                                <hr>
                                <p class="card-text">Web Edukasi Open Source yang dibuat oleh Mohamad Afid Yoga Pratama Putra <br> AMIKOM adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> AMIKOM dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2024 <div class="bullet"></div><a href="https://github.com/afidyoga">Mohamad Afid Yoga Pratama Putra</a>
                </div>
            </footer>
            <!-- End Footer -->
