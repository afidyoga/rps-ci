...
<head>
    ...
    <title>Tambah Data Materi - RPS AMIKOM </title>
    <!-- General CSS Files -->
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - AMIKOM
                            </div>
                                    ...
                                    <div class="col-md-12 bg-white" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small>Jika nama mapel sudah berganti artinya nama dosen yang kamu
                                                    masukan di input area adalah valid! jika tidak muncul nama mapel
                                                    anda harus klik input area nama dosen dan pilih dosen yang tersedia
                                                    disana.</small>
                                            </div>
                                            <div class="form-group">
