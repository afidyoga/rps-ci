            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi/ RPS</h2>
                            <hr>
                           <p class="card-text">Jumlah Materi yang terdata di AMIKOM sekarang adalah 
                            <span class="font-weight-bold" style="color:black;">
                                <?php echo $this->db->count_all('materi'); ?> Materi.
                            </span>Materi dapat ditambah oleh Dosen maupun admin, materi meliputi video, deskripsi dan modul - modul Pembelajaran </p>
                            <a href="<?= base_url('admin/tambah_materi') ?>" class="btn btn-success"><i class="fa fa-plus-square"></i> Tambah
                                Data Materi/ RPS </a>
                            <a href="<?= base_url('materi/print_materi') ?>" class="btn btn-danger" target="_blank"><i class="fa fa-print"></i> Print </a>
                            </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
