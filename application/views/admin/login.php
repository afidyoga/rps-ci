...
<head>
    ...
    <title>AMIKOM - Admin Login</title>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <a href="<?=base_url('welcome')?>"> <img src="<?=base_url('assets/')?>/img/logo-amikom.png" alt="logo"
                                width="150" class=" mb-5 mt-2"></a>
                        <h4 class="text-dark font-weight-normal">Selamat datang di <span
                                class="font-weight-bold">RPS AMIKOM</span>
                        </h4>
                        ...
                        <form method="post" action="<?=base_url('welcome/admin')?>" class="needs-validation"
							...
							<br><center><p>Repost by <a href='http://techdiscoveryuniverse.com/' title='techdiscoveryuniverse.com' target='_blank'>techdiscoveryuniverse.com</a></p></center>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb"
                                target="_blank" href="">Mohamad Afid Yoga Pratama Putra</a> - Image by <a
