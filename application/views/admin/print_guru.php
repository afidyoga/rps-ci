...
<body><br><br>
  <img src="../assets/img/logo-amikom.png" style="position: absolute; width: 240px; height: auto;">
  <table style="width: 100%;">
    <tr>
      <td align="center">
        <span style="line-height: 2; font-weight: bold; ">
          <h2>UNIVERSITAS AMIKOM
          <br>YOGYAKARTA</h2>
        </span>
      </td>
    </tr>
  ...
  <hr class="line-title"> 
  <p align="center">
    <B>LAPORAN DATA DOSEN PENGAJAR </B><br>
  </p>
  ...
  <table border="0" width="100%">
                      <tr>
                        ...
                        <td width="50%"></td>
                        <td width="25%" align="center">Yogyakarta, <?php echo tgl_indo($date) ?><br><br> Hormat Kami</td>
                      </tr>
                        <td height="100px"></td>
                        <td></td>
                        <td></td>
