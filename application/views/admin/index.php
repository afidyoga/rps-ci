...
<head>
	...
	<title>Admin Dashboard - RPS AMIKOM</title>
	<!-- General CSS Files -->
	<link rel="icon" href="<?= base_url('assets/') ?>img/amikom.png" type="image/png">
		...
		<div class="main-wrapper">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - AMIKOM</div>
			...
			<div class="main-sidebar">
				<aside id="sidebar-wrapper">
					<div class="sidebar-brand text-danger">
						<div>
							<a href="<?= base_url('admin') ?>" style="font-size: 21px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 30px;" class="fas fa-book"></i> RPS AMIKOM</a>
						</div>
					</div>
					<div class="sidebar-brand sidebar-brand-sm">
						<a href="<?= base_url('admin') ?>">RPS <sup>3</sup></a>
					</div>
					<ul class="sidebar-menu">
						...
						<li class="menu-header">Management Materi/ RPS</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i>
                                <span>Materi/ RPS</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/data_materi') ?>">Data Materi/ RPS</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('admin/tambah_materi') ?>">Tambah Materi/ RPS</a>
                                </li>
                            </ul>
                        </li>
                </aside>
			...
			<footer class="main-footer">
				<div class="text-right">
					Repost by <a href='https://techdiscoveryuniverse.com/' title='techdiscoveryuniverse.com' target='_blank'>techdiscoveryuniverse.com</a> | Copyright &copy; 2024 <div class="bullet"></div><a href="https://github.com/afidyoga"> Mohamad Afid Yoga Pratama Putra</a>
				</div>
			</footer>
			<!-- End Footer -->
