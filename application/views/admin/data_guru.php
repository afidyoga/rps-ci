            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Dosen</h2>
                            <hr>
                            <p class="card-text">Jumlah Dosen yang terdaftar di Learnify sekarang adalah
                            <span class="font-weight-bold" style="color:black;">
                                <?php echo $this->db->count_all('guru'); ?> Dosen.
                            </span>Dosen tidak dapat melakukan pendaftaran online sendiri. Hanya admin yang diperkenankan untuk mendaftarkan Dosen. </p>
    ...
    <?php if ($this->session->flashdata('success-reg')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Data Dosen Telah Ditambah!',
