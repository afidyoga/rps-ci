    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang RPS AMIKOM</a></li>
                        <li><a href="<?= base_url('welcome/Berita') ?>">Pengumuman RPS AMIKOM</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak RPS AMIKOM</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="javaScript:void(0);">PERANCANGAN WEB 2</a></li>
                        <li><a href="javaScript:void(0);">PENGOLAHAN BASISDATA</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang RPS AMIKOM</h4>
                <p>
                    RPS AMIKOM adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. RPS AMIKOM dibuat ditujukan agar para Mahasiswa dan Dosen dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> RPS AMIKOM is made with <span class="text-danger"> &#10084;</span> by <a href="">Mohamad Afid Yoga Pratama Putra </a> with ColorLib
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/afid_yoga"><i class="fa fa-twitter"></i></a>
                <a href="https://dribbble.com/afid_yoga"><i class="fa fa-dribbble"></i></a>
                <a href="https://www.behance.net/afid_yoga"><i class="fa fa-behance"></i></a>
                <a href="https://www.github.com/afidyoga"><i class="fa fa-github"></i></a>
                <a href="https://www.instagram.com/afid_yoga"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-dark font-weight-bold" style="color:#212529 !important;" id="exampleModalCenterTitle">
                    RPS AMIKOM - Masuk Sekarang | Repost by <a href='http://techdiscoveryuniverse.com/' title='techdiscoveryuniverse.com' target='_blank'>techdiscoveryuniverse.com</a>
					</h2>
