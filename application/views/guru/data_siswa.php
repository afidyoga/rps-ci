            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Mhasiswa AMIKOM</h2>
                            <hr>
                            <p class="card-text">Jumlah Mahasiswa yang terdaftar di Learnify Education sekarang adalah
